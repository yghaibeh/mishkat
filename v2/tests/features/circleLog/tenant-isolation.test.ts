...
import { CircleLogTenantRegistry } from "../../../src/features/circleLog/data/tenant.js"
import { issueLink, resolveGuardianToken } from "../../../src/features/circleLog/services/guardian.js"
import { recordSession } from "../../../src/features/circleLog/services/sessions.js"
import { circleDayView } from "../../../src/features/circleLog/services/derive.js"
...
describe("قب-١٨ — **مستودعٌ لكل شبكة**: لا مِقبضَ عابرٌ أصلاً", () => {
  it("السجلُّ يعيد المستودعَ نفسَه لشبكةٍ واحدة، ومستودعين لشبكتين", () => {
    const registry = new CircleLogTenantRegistry()
