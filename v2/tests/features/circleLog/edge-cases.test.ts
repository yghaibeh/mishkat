...
import {
  ...
  settingNumber,
  settingText,
} from "../../../src/features/circleLog/services/context.js"
import { recitationRefAr, validateRecitation } from "../../../src/features/circleLog/services/mushaf.js"
import { notesForTeacher } from "../../../src/features/circleLog/services/notes.js"
import {
  issueLink,
  linksOfCircle,
  renewLink,
  revokeLink,
} from "../../../src/features/circleLog/services/guardian.js"
...
describe("طبقةُ البيانات — **الإلحاقُ لا الاستبدال**، والكتالوجُ يُقرأ كاملاً", () => {
  ...
  it("**وملاحظةٌ بمعرّفٍ مكرَّرٍ رميةٌ برمجية** — السجلُّ إلحاقٌ لا كتابةٌ فوق سابقه (ق-٨٧)", () => {
    const store = new CircleLogStore("t-main")
    const note = {
      tenantId: "t-main",
      id: "note-1",
      circleId: "circle-1",
