...
import type { TahfeezLogContext } from "../../../src/features/tahfeezLog/services/context.js"
...
export function seedLogStore(tenantId: string = MAIN_TENANT_ID): TahfeezLogStore {
  const store = new TahfeezLogStore(tenantId)
