 ...
 * > صندوقُ الشخص شبكيٌّ بالبناء، فأوّلُ تجاوزٍ **يتعذّر إصلاحُه بتضييق النطاق** ⟵ هو **زنادُ
 * > CR-026 بعينه** (قب-٤٨): يُعاد فتحه ويُنفَّذ التحويلُ إلى عقودٍ غيرِ متزامنة، لا يُرفع السقفُ صامتاً.
 */
