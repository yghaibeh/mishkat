 ...
 *
 * > **ولماذا لم يُستعمل وسمُ `hard-constant:` الذي بنته البوابةُ نفسُها؟** لأنه **لا يعمل**:
 ...
 * > رُفع في `CR-DRAFT-payroll-minutes-per-hour` §٣ ليصلحه المديرُ، والحسابُ هنا صريح.
 */
